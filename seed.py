...
print()
print("=" * 60)
print("SEED COMPLETE — Dev login URLs (FLASK_ENV=development only)")
print("=" * 60)
print()
print(f"  Super Admin    → token: {SES_ADMIN}")
print(f"    Dev login:  {BASE}/dev-login/{SES_ADMIN}")
print()
print(f"  Vendor 1 (Krishna Chemicals — APPROVED)")
print(f"           → token: {SES_VENDOR1}")
print(f"    Dev login:  {BASE}/dev-login/{SES_VENDOR1}")
print()
print(f"  Vendor 2 (Shiva Shakti — UNDER REVIEW)")
print(f"           → token: {SES_VENDOR2}")
print(f"    Dev login:  {BASE}/dev-login/{SES_VENDOR2}")
print()
print(f"  Transporter 1 (Speed Logistics — APPROVED)")
print(f"           → token: {SES_TRANS1}")
print(f"    Dev login:  {BASE}/dev-login/{SES_TRANS1}")
print()
print(f"  Transporter 2 (Bharat Freight — PENDING)")
print(f"           → token: {SES_TRANS2}")
print(f"    Dev login:  {BASE}/dev-login/{SES_TRANS2}")
print()
print("Just open the dev-login URL in your browser — it sets the")
print("session cookie automatically and redirects to the portal.")
print()
